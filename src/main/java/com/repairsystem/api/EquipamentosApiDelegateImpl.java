...
public class EquipamentosApiDelegateImpl implements EquipamentosApiDelegate {
    ...
    @Override
    public ResponseEntity<PageEquipamentoResponseDTO> getEquipamentosByCategoria(
            CategoriaEquipamento categoria, Optional<Integer> page, Optional<Integer> size) {
        int pageNum = page.orElse(0);
        int pageSize = size.orElse(20);
        Pageable pageable = PageRequest.of(pageNum, pageSize);
        
        var categoriaEnum = com.repairsystem.domain.enums.CategoriaEquipamento.valueOf(categoria.getValue());
    ...
    @Override
    public ResponseEntity<PageEquipamentoResponseDTO> getEquipamentosByTipo(
            String tipo, Optional<Integer> page, Optional<Integer> size) {
        int pageNum = page.orElse(0);
        int pageSize = size.orElse(20);
        Pageable pageable = PageRequest.of(pageNum, pageSize);
    ...
    @Override
    public ResponseEntity<PageEquipamentoResponseDTO> getEquipamentosByFabricante(
            Long fabricanteId, Optional<Integer> page, Optional<Integer> size) {
        int pageNum = page.orElse(0);
        int pageSize = size.orElse(20);
        Pageable pageable = PageRequest.of(pageNum, pageSize);
    ...
    @Override
    public ResponseEntity<PageEquipamentoResponseDTO> searchEquipamentosByModelo(
            String modelo, Optional<Integer> page, Optional<Integer> size) {
        int pageNum = page.orElse(0);
        int pageSize = size.orElse(20);
        Pageable pageable = PageRequest.of(pageNum, pageSize);
    ...
    public ResponseEntity<EquipamentoResponseDTO> updateEquipamento(
            Long id, EquipamentoRequestDTO equipamentoRequestDTO) {
